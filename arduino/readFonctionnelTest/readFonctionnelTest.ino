...
MFRC522::MIFARE_Key key0A = {keyByte: {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}}; // écriture des clés de chaque secteur
MFRC522::MIFARE_Key key0B = {keyByte: {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}}; // écriture des clés de chaque secteur
